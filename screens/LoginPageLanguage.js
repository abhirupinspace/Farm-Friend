  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <Text style={[styles.continueWithEnglish, styles.farmFriendClr]}>
          Continue WIth English
        </Text>
      </Pressable>
      <Text style={[styles.hackwaveNexus, styles.hackwaveNexusTypo]}>
        ©HackWave Nexus
      </Text>
      ...
      <Text style={styles.text}>{`असुविधा के लिए खेद है।
ऐप की भाषा सुविधाएँ अभी भी विकासाधीन हैं।`}</Text>
